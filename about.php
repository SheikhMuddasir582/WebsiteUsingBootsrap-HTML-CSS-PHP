...
<head>
    ...
    <title>About SM Stationary</title>
</head>

<body>
    <!-- code from here -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="/">SM Stationary</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <a class="nav-link" href="/AssignWeb">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="/AssingWeb/about.php">About</a>
                </li>
    ...
    <div class="container mt-3">
        ...
        <div class="row justify-content-center">
            <div class="card mx-2" style="width: 18rem;">
                ...
                <div class="card-body">
                  <h5 class="card-title">Best Stationary in Pindi</h5>
    ...
    <footer class="container">
        ...
        <p>© 2017-2023 SM Stationary, Inc. · <a href="#">Privacy</a> · <a href="#">Terms</a></p>
        <hr>
      </footer>
